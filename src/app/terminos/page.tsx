  ...
  return (
    <div style={{ background: '#020617', color: 'white', minHeight: '100vh', padding: '60px 20px', fontFamily: 'system-ui, sans-serif' }}>
      <div style={{ maxWidth: '800px', margin: '0 auto', background: 'rgba(255,255,255,0.03)', padding: '40px', borderRadius: '20px', border: '1px solid rgba(255,255,255,0.1)' }}>
        <h1 style={{ fontSize: '2.5rem', marginBottom: '20px', color: '#06b6d4' }}>Términos y Condiciones y Política de Privacidad</h1>
        ...
        <h2 style={{ fontSize: '1.5rem', marginBottom: '15px', color: '#e2e8f0' }}>2. Tratamiento de Datos Personales (Ley 25.326)</h2>
        <p style={{ color: '#94a3b8', marginBottom: '20px', lineHeight: '1.6' }}>
        ...
        <h2 style={{ fontSize: '1.5rem', marginBottom: '15px', color: '#e2e8f0' }}>3. Derechos de los Usuarios y Menores de Edad</h2>
        <p style={{ color: '#94a3b8', marginBottom: '20px', lineHeight: '1.6' }}>
        ...
        <h2 style={{ fontSize: '1.5rem', marginBottom: '15px', color: '#e2e8f0' }}>4. Confidencialidad y Seguridad</h2>
        <p style={{ color: '#94a3b8', marginBottom: '20px', lineHeight: '1.6' }}>
        ...
        <h2 style={{ fontSize: '1.5rem', marginBottom: '15px', color: '#e2e8f0' }}>5. Interacción con el Bot (Inteligencia Artificial)</h2>
        <p style={{ color: '#94a3b8', marginBottom: '20px', lineHeight: '1.6' }}>
        ...
        <h2 style={{ fontSize: '1.5rem', marginBottom: '15px', color: '#e2e8f0' }}>6. Contacto Legal</h2>
